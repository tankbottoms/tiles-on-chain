...
Prices depend on the current amount of Tiles already minted, the price starts at `0.0001 Ether` and doubles every `512 mints`. These two numbers are configuration parameters. Holders of the original Tiles NFTs at [0x64931F06d3266049Bf0195346973762E6996D764](https://looksrare.org/collections/0x64931F06d3266049Bf0195346973762E6996D764) can mint their Tiles on [this contract](https://etherscan.io/address/0xa0dadfA9279C1379CfcAbd8e21Af78b9064cCeb0) for free.
